...
public class MainActivity extends AppCompatActivity {
    ...
    private ImageButton button01,button02,button03,button04,button05,button06,button07,button08,button08a,button09;
    public  MainActivity(){
...
//        button03 = (Button)findViewById(R.id.button03);
        ...
        button08a =findViewById(R.id.button08a);
        ...
        button08a.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tts.setPitch(1.0f);
